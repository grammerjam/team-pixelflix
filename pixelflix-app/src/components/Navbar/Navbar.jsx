  ...
  return (
    <section className='navbar'>
      ...
      <div className="navbar__page-icons">
        <div className="navbar__imgcontainer">
          <Link to="/home">
            <img className='navbar__icon-home' src={homeIcon}/>
          </Link>
        </div>
        <div className="navbar__imgcontainer">
          <Link to="/movies">
            <img className='navbar__icon-movies' src={movieIcon}/>
          </Link>
        </div>
        <div className="navbar__imgcontainer">
          <Link to="/tv">
            <img className='navbar__icon-tv' src={tvIcon}/>
          </Link>
        </div>
        <div className="navbar__imgcontainer">
          <Link to="/bookmarks">
            <img className='navbar__icon-bookmark' src={bookmarkIcon}/>
          </Link>
        </div>
      </div>
